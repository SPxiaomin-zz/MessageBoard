...
/* 0 */
/*!**********************************************!*\
  !*** ./public/javascript/build/component.js ***!
  \**********************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var $ = __webpack_require__(/*! ../lib/jquery.min.js */ 166);
	...
	var Comment = React.createClass({
	    ...
	    render: function () {
	        return React.createElement(
	            ...
	            React.createElement(
	                'footer',
	                { className: 'board-main-item-origin' },
	                React.createElement(
	                    'time',
	                    null,
	                    this.props.dtime
	...
	var CommentList = React.createClass({
	    ...
	    render: function () {
	        var commentNodes = this.props.data.map(function (comment) {
	            return React.createElement(
	                Comment,
	                { key: comment._id, author: comment.author, dtime: comment.dtime },
	                comment.msg
	            );
	        });
	        return React.createElement(
	            'ul',
	            { className: 'board-main-list' },
	            React.createElement(
	                ReactCSSTransitionGroup,
	                { transitionName: 'comment', transitionEnterTimeout: 500, transitionLeave: false },
	                commentNodes
	            )
	        );
	    }
	...
	var CommentForm = React.createClass({
	    ...
	    render: function () {
	        return React.createElement(
	            'div',
	            { className: 'board-main-form', onSubmit: this.handleSubmit },
	            React.createElement(
	                'form',
	                { name: 'js_form' },
	                React.createElement(
	                    ...
	                    React.createElement(
	                        ...
	                        React.createElement('input', { type: 'text', id: 'name', name: 'js_name', placeholder: 'Your name...', required: true, ref: 'author', defaultValue: this.author }),
	                        React.createElement(
	                            'span',
	                            { id: 'js_name_form_hint', className: 'form-hint' },
	                            '正确格式为：1~18个字符，可使用汉字、字母(已输入字符数: ',
	                            React.createElement('span', { id: 'js_name_cnt' }),
	                            ')'
	                        )
	                    ),
	                    React.createElement(
	                        ...
	                        React.createElement('textarea', { id: 'msg', name: 'js_msg', placeholder: 'Say something...', required: true, ref: 'msg' }),
	                        React.createElement(
	                            'span',
	                            { id: 'js_msg_form_hint', className: 'form-hint' },
	                            '正确格式为：1~240个字符(已输入字符数: ',
	                            React.createElement('span', { id: 'js_msg_cnt' }),
	                            ')'
	                        )
	                    ),
	                    React.createElement(
	...
	var CommentBox = React.createClass({
	    ...
	    render: function () {
	        return React.createElement(
	            ...
	            React.createElement(
	                'div',
	                { className: this.state.addLoading },
	                React.createElement('p', null)
	            ),
	            React.createElement(CommentList, { data: this.state.data }),
	            React.createElement(
	                'div',
	                { className: this.state.moreLoading },
	                React.createElement('p', null)
	            ),
	            React.createElement(
	                'p',
	                { className: this.state.noMore },
	                '已经到底啦～'
	            )
	        );
	    }
	...
	ReactDOM.render(React.createElement(CommentBox, null), document.getElementById('js_board_main_container'));
...
/* 166 */
/*!*********************************************!*\
  !*** ./public/javascript/lib/jquery.min.js ***!
  \*********************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	!function (a, b) {
	  ...
	  var c = [],
	    ...
	    n.each({ padding: "inner" + a, content: b, "": "outer" + a }, function (c, d) {
	      ...
	      return this.length;
	    } }), n.fn.andSelf = n.fn.addBack, "function" == "function" && __webpack_require__(/*! !webpack amd options */ 167) && !(__WEBPACK_AMD_DEFINE_ARRAY__ = [], __WEBPACK_AMD_DEFINE_RESULT__ = function () {
	    return n;
