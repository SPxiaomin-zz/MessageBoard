	            ...
	            React.createElement(
	                ...
	                React.createElement(
	                    ...
	                    React.createElement(
	                        ...
	                        React.createElement('input', { type: 'text', id: 'name', name: 'js_name', placeholder: 'Your name...', required: true, ref: 'author', defaultValue: this.author, onFocus: this.nameFocusHandler, onKeyUp: this.nameKeyupHandler }),
	                        React.createElement(
	                            'span',
	                            { id: 'js_name_form_hint', className: 'form-hint' },
	                            '正确格式为：1~18个字符，可使用汉字、字母(已输入字符数: ',
	                            React.createElement('span', { id: 'js_name_cnt', ref: 'nameCnt' }),
	                            ')'
	                        )
	                    ),
	                    React.createElement(
	                        ...
	                        React.createElement('textarea', { id: 'msg', name: 'js_msg', placeholder: 'Say something...', required: true, ref: 'msg', onFocus: this.msgFocusHandler, onKeyUp: this.msgKeyupHandler }),
	                        React.createElement(
	                            'span',
	                            { id: 'js_msg_form_hint', className: 'form-hint' },
	                            '正确格式为：1~240个字符(已输入字符数: ',
	                            React.createElement('span', { id: 'js_msg_cnt', ref: 'msgCnt' }),
	                            ')'
	                        )
	                    ),
	                    React.createElement(
