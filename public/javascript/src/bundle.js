...
/***/ function(module, exports, __webpack_require__) {
	        ...
	        return React.createElement(
	            ...
	            React.createElement(
	                ...
	                React.createElement(
	                    'p',
	                    null,
	                    React.createElement('input', { type: 'text', placeholder: 'Your name...', ref: 'author', defaultValue: this.author })
	                ),
	                React.createElement(
	                    'p',
	                    null,
	                    React.createElement('textarea', { placeholder: 'Say something...', ref: 'msg' })
	                ),
	                React.createElement(
	                    'p',
	                    null,
	        ...
	        promise.done(function (data) {
	            if (data) {
	                var comments = that.state.data,
	                    newComments = data.ops.concat(comments);
	                that.setState({
	                    data: newComments,
	                    addLoading: "loading"
	                });
	...
	ReactDOM.render(React.createElement(CommentBox, null), document.getElementById("commentWrap"));
